...
def clasificadorDePosiciones(dedos, frame, perfil):
    ...
    if dedos == [1, 1, 1, 1, 1, 1] and not perfil:  #[1,0,1,0,0,0]
        cv2.rectangle(frame,(0,0),(100,100),(255,255,255), -1)
    ...
    # falla
    if dedos == [1, 1, 0, 0, 0, 1] and perfil:
        cv2.rectangle(frame, (0, 0), (100, 100), (255, 255, 255), -1)
        cv2.putText(frame, 'G', (20, 80), font, 3, (0, 0, 0), 2, cv2.LINE_AA)
        print("G")
        detected_letter = 'G'

    if dedos == [0, 1, 0, 0, 1, 1] and perfil:
        cv2.rectangle(frame, (0, 0), (100, 100), (255, 255, 255), -1)
    ...
    if dedos == [1, 1, 1, 1, 1, 1] and perfil:  # [1, 0, 1, 0, 0, 0]
        cv2.rectangle(frame, (0, 0), (100, 100), (255, 255,255), -1)
    ...
    if dedos == [0, 1, 0, 0, 1, 1] and not perfil:
        cv2.rectangle(frame, (0, 0), (100, 100), (255, 255,255), -1)
