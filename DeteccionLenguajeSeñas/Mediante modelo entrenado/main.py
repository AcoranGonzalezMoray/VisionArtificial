    ...
    for sign_r in sign_language_results:
        ...
        for box in boxes:
            ...
            if sign_language_className[cls] in ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J",
                ...
                text_width, text_height = cv2.getTextSize(sign_language_className[cls], cv2.FONT_HERSHEY_SIMPLEX, 1, 2)[
                    0]
                ...
                cv2.rectangle(frame, (x1_background, y1_background), (x2_background, y2_background), (255, 255, 255),
                              -1)
